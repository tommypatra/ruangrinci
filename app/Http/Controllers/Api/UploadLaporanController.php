...
use App\Http\Requests\UploadLaporanRequest;
use App\Http\Resources\UploadLaporanResource;
...
class UploadLaporanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = UploadLaporan::orderBy('id', 'asc')
            ->with([
                'laporan', 'upload'
            ]);
        ...
        return UploadLaporanResource::collection($data);
    }
    ...
    public function store(UploadLaporanRequest $request)
    {
        $validatedData = $request->validated();
        try {
            $data = UploadLaporan::create($validatedData);
            return response()->json([
                'success' => true,
                'message' => 'created successfully',
                'data' => new UploadLaporanResource($data),
            ], 201);
    ...
    //OKE PUT application/x-www-form-urlencoded
    public function update(UploadLaporanRequest $request, $id)
    {
