...
@section('head')
<title>Validasi Peminjaman Barang</title>
...
@section('pageTitle')
<div class="pagetitle">
    <h1>Validasi Peminjaman Barang</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('akun-dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">Validasi Peminjaman Barang</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
@endsection
...
<div class="col-lg-12">
    <div class="row">
        <div class="card info-card customers-card">
            ...
            <div class="card-body">
                <h5 class="card-title">Validasi Peminjaman <span>| Barang</span></h5>
...
<script type="text/javascript">
    ...
    var vJudul='Validasi Peminjaman Barang';
    var fieldInit={
        'id': { action: 'val' },
        'no_hp': { action: 'val' },
        'biaya': { action: 'val' },
            ...
            $.each(data, function(index, dt) {
                ...
                var row = `
                    <tr>
                        <td>${nomor++}</td>
                        <td>
                            <span class="badge bg-secondary">${dt.data_aset.jenis_aset.nama}</span>
                            <p>
                                ${dt.data_aset.nama}
                                <hr>
                                ${dt.keterangan}
