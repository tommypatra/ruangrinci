...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Detail-Peminjaman-Ruangan</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
@endsection
...
<div class="col-lg-12">
    <div class="row">
        <div class="card info-card customers-card">
            ...
            <div class="card-body">
                <h5 class="card-title">Detail Peminjaman  <span>| Ruangan</span></h5>
                <div class="d-flex align-items-center">
                    <div class="row">
                        <h5 id="ruang" style="font-weight:bold;">Ruangan</b></h5>
                        <div id="gedung" style="font-style:italic;">Gedung</div>
...
<script type="text/javascript">
    ...
    var vJudul='Detail Peminjaman Ruangan';

    // statusPember itahuan(vIdPemberitahuan);
    load();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.data.length>0) {
                    ...
                    $("#ruang").html(dt.ruangan.nama);
                    $("#gedung").html(dt.ruangan.gedung.nama);
