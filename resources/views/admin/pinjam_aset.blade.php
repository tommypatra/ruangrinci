...
<div class="col-lg-12">
    <div class="row">
        <div class="card info-card customers-card">
            ...
            <div class="card-body">
                <h5 class="card-title">Peminjaman <span>| Barang</span></h5>
                        ...
                        <table class="table" >
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:20%">Barang/Jenis</th>
...
<script>
    ...
    var vJudul='Pengajuan Peminjaman Aset/Barang';
    var apiEndPoint = 'pinjam-aset';
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response.data, function(index, dt) {
                            ...
                            var eventItem = {
                                title: '['+dt.peminjam_nama+'] '+dt.data_aset.nama+' - '+dt.keterangan+' '+dt.verifikasi_catatan,
...
<script type="text/javascript">
            ...
            $.each(data, function(index, dt) {
                ...
                var row = `
                    <tr>
                        ...
                        <td>${dt.data_aset.nama} <div style="font-size:11px;">[${dt.data_aset.jenis_aset.nama}]</div></td>
                        <td>${dt.keterangan}</td>
                        <td>
                            ${verifikasi}
    ...
    function tambah() {
        ...
        $('#data_aset_id').prop('disabled', false);
    };
    ...
    function ganti(id) {
        ...
        $('#data_aset_id').prop('disabled', true);
        ...
        CrudModule.fEdit(id, function(response) {
            if(response.success){
                ...
                if(dt.data_aset_id){ 
                    ...
                    var option_add = new Option(dt.data_aset.nama, dt.data_aset.id, true, true);
    ...
    //simpan baru atau simpan perubahan
    function simpan2(setup_ajax,form) {
        var dataForm = new FormData($(form)[0]);
        // console.log(dataForm);
                        ...
                        if(response.data.is_pengajuan){
                            $.each(adminIds, function(index, admin_id) {
                                var parameter={
                                    ...
                                    'user_id':admin_id,
                                    'link':'pinjam-aset-validasi',
                                    'judul':'Peminjaman Barang',
                                    'pesan':'Mohon dicek, ada pengajuan peminjaman barang',
                                };
